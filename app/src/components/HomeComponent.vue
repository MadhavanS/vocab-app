<template>
  <div>
    ...
    <div class="mt-6 border-2 border-blue-400 md:w-2/3 lg:w-1/2 mx-auto rounded-3xl">
  ...
  <div class="mt-6 border-2 border-blue-400 md:w-2/3 lg:w-1/2 mx-auto rounded-3xl">
    <div class="antialiased text-gray-600 p-4 container">
...
onMounted(async () => {
  ...
  if(totalRecordCount.value === 0) alertMessage.value = 'Sorry, no results found !!!'
  else alertMessage.value = '';
